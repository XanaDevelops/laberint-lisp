...
(defun-tco 
  ...
  (cond 
    ...
    (t
     (let 
       ((posActual (casellaAdjacentRandom laberint pos))) ; casella adjaçent random
       ...
       (cond 
         ...
         (t
          (let 
            ((pos2 (casellaAdjacentRandom laberint pos)))
            
            (recursiveDFS pos2 laberint)
